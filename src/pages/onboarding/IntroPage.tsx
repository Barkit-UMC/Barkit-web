...
export default function IntroPage() {
    ...
    return (
        <div className="flex-1 flex flex-col px-6 pb-8 bg-white overflow-hidden">
            {/* 0. 애니메이션 스타일 주입 (Tailwind config 없이 바로 적용) */}
            <style>{`
                @keyframes float {
            ...
            <div className="flex-1 relative flex items-center justify-center -mt-10">
                ...
                {/* 흰색 박스(bg-white, shadow) 제거 -> 순수 아이콘만 둥둥 떠다니게 변경 */}
                ...
                {/* KT (우측 상단) */}
                <div
                    className="absolute top-35 right-10 z-0 animate-float w-16 h-16"
                ...
                {/* Olive Young (좌측 하단) */}
                <div
                    className="absolute bottom-40 left-5 z-0 animate-float w-16 h-16"
                ...
                {/* Happy Point (우측 하단) */}
                <div
                    className="absolute bottom-25 right-5 z-0 animate-float w-16 h-16"
